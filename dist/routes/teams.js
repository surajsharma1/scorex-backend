...
router.post('/', auth_1.protect, teamController.createTeam);
router.put('/:id', auth_1.protect, teamController.updateTeam);
router.delete('/:id', auth_1.protect, teamController.deleteTeam);
