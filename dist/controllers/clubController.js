...
const createClub = async (req, res) => {
    try {
        ...
        await club.save();
        logger_1.logger.info(`Club created: ${name} by ${userId}`);
...
const getClubs = async (req, res) => {
    try {
        ...
        logger_1.logger.error('Error getting clubs:', error);
        res.status(500).json({ message: 'Internal server error' });
    }
};
...
const getClub = async (req, res) => {
    try {
        ...
        logger_1.logger.error('Error getting club:', error);
        res.status(500).json({ message: 'Internal server error' });
    }
};
...
const joinClub = async (req, res) => {
    try {
        ...
        await club.save();
        logger_1.logger.info(`User ${userId} joined club ${clubId}`);
        res.json({ message: 'Joined club successfully', club });
    }
    catch (error) {
        logger_1.logger.error('Error joining club:', error);
        res.status(500).json({ message: 'Internal server error' });
    }
};
...
const leaveClub = async (req, res) => {
    try {
        ...
        await club.save();
        logger_1.logger.info(`User ${userId} left club ${clubId}`);
        res.json({ message: 'Left club successfully' });
    }
    catch (error) {
        logger_1.logger.error('Error leaving club:', error);
        res.status(500).json({ message: 'Internal server error' });
    }
};
...
const updateClub = async (req, res) => {
    try {
        ...
        await club.save();
        logger_1.logger.info(`Club updated: ${clubId}`);
        ...
        logger_1.logger.error('Error updating club:', error);
        res.status(500).json({ message: 'Internal server error' });
    }
};
...
const deleteClub = async (req, res) => {
    try {
        ...
        logger_1.logger.info(`Club deleted: ${clubId}`);
        res.json({ message: 'Club deleted successfully' });
    }
    catch (error) {
        logger_1.logger.error('Error deleting club:', error);
        res.status(500).json({ message: 'Internal server error' });
    }
};
