...
export declare const goLive: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
export declare const updateLiveScores: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
